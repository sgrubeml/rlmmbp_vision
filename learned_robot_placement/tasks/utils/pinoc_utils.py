...
class PinTiagoIKSolver(object):
    def __init__(
        ...
        # urdf_name: str = "tiago_dual_omni_robotiq_holobase.urdf",
    ...
    def solve_ik_pos_tiago(self, des_pos, des_quat, curr_joints=None, frame=None, n_trials=7, dt=0.1, pos_threshold=0.05, angle_threshold=15.*np.pi/180, verbose=False):
