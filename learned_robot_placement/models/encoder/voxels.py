...
from learned_robot_placement.models.encoder.unet import UNet
from learned_robot_placement.models.encoder.unet3d import UNet3D
...
class LocalVoxelEncoder(nn.Module):
    ...
    def __init__(self, c_dim=128, unet=False, unet_kwargs=None, unet3d=False, unet3d_kwargs=None, 
                 plane_resolution=64, grid_resolution=None, plane_type=['xz', 'xy', 'yz'], kernel_size=3, padding=0.1):
        super().__init__()
        self.actvn = F.relu
        if kernel_size == 1:
    ...
    def generate_plane_features(self, p, c, plane):
        ...
        if self.unet is not None:
            ...
            # TODO: add regular 2D convolutions to get global feature of c_dim length, start with 2 or 3 layers --> same depth as voxel encoder
    ...
    #     else:
    #         # TODO: add regular 2D convolutions to get global feature of c_dim length
    #         raise NotImplementedError
    ...
    def forward(self, x):
        ...
        # TODO: aggregate feature plane features into one global feature, concatenate the 3 features
...
class VoxelEncoder(nn.Module):
    ...
    def forward(self, x):
        ...
        hidden = net.view(batch_size, 256)
